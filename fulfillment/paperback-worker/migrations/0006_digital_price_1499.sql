-- Admit the current $14.99 individual digital offers and the three-title
-- $44.97 total while preserving every verified historical $29/$69 purchase.
-- SQLite CHECK constraints require the table to be rebuilt.
