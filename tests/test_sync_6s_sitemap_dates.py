...
from scripts.sync_6s_sitemap_dates import SITEMAP_NAMESPACE, update_sitemap_text
from scripts.validate_6s_cluster import BASE_URL, MODIFIED_DATES


class Sync6SSitemapDatesTests(unittest.TestCase):
    def test_each_6s_url_receives_its_approved_date(self):
