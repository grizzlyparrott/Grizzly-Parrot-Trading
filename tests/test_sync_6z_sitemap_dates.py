...
from scripts.sync_6z_sitemap_dates import SITEMAP_NAMESPACE, update_sitemap_text
from scripts.validate_6z_cluster import BASE_URL, MODIFIED_DATES


class Sync6ZSitemapDatesTests(unittest.TestCase):
    def test_each_6z_url_receives_its_approved_date(self):
        ...
        updated, _ = update_sitemap_text(ET.tostring(root, encoding="unicode"))
